...
using namespace std;
static matrix_t L[matrix_size][matrix_size]={0};
...
#pragma HLS INTERFACE m_axi port=B offset=slave bundle=input
#pragma HLS INTERFACE m_axi port=C offset=slave bundle=output

#pragma HLS INTERFACE s_axilite port=return
	matrix_t AA[matrix_size][matrix_size];
